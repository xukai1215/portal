...
Sidebar.prototype.init = function()
{
	...
	generalTab.style= "border: 0px solid rgb(192, 192, 192); text-align: center; font-weight: bold; overflow: hidden; display: inline-block; padding-top: 8px; height: 25px; width: 33.3%;background-color: rgb(215, 215, 215);border-left:2px solid rgb(192,192,192)";
	...
	generalTab.onclick=function(){
		...
		document.getElementById("general_tab").style= "border: 0px solid rgb(192, 192, 192); text-align: center; font-weight: bold; overflow: hidden; display: inline-block; padding-top: 8px; height: 25px; width: 33.3%;background-color: rgb(215, 215, 215);border-left:2px solid rgb(192,192,192)";
		document.getElementById("geoicon_tab").style= "border-width: 0px 0px 1px 1px; border-style: solid; border-color: rgb(192, 192, 192); border-image: initial; text-align: center; font-weight: bold; overflow: hidden; display: inline-block; padding-top: 8px; height: 25px; width: 33.3%;";
	};
	
	var geoIconTab = document.createElement("div");
	geoIconTab.style = "border-width: 0px 0px 1px 1px; border-style: solid; border-color: rgb(192, 192, 192); border-image: initial; text-align: center; font-weight: bold; overflow: hidden; display: inline-block; padding-top: 8px; height: 25px; width: 33.3%;";
	...
	geoIconTab.onclick=function(){
		...
		document.getElementById("geoicon_tab").style= "border: 0px solid rgb(192, 192, 192); text-align: center; font-weight: bold; overflow: hidden; display: inline-block; padding-top: 8px; height: 25px; width: 33.3%;background-color: rgb(215, 215, 215);box-shadow:2px 0px rgb(192,192,192)";
		document.getElementById("general_tab").style= "border-width: 0px 0px 1px 1px; border-style: solid; border-color: rgb(192, 192, 192); border-image: initial; text-align: center; font-weight: bold; overflow: hidden; display: inline-block; padding-top: 8px; height: 25px; width: 33.3%; ";
	};
	...
	this.addPaletteFunctions("Water System", "Water System", true, fns, this.sideGeoIconContainer);
	this.addPaletteFunctions("Soil System", "Soil System", false, fns, this.sideGeoIconContainer);
	this.addPaletteFunctions("Atmosphere System", "Atmosphere System", false, fns, this.sideGeoIconContainer);	
	this.addPaletteFunctions("Biography System", "Biography System", false, fns, this.sideGeoIconContainer);
	this.addPaletteFunctions("Human/Social/Economic", "Human/Social/Economic", false, fns, this.sideGeoIconContainer);
	this.addPaletteFunctions("Land Surface System", "Land Surface", false, fns, this.sideGeoIconContainer);
	this.addPaletteFunctions("Ocean System", "Ocean System", false, fns, this.sideGeoIconContainer);
	this.addPaletteFunctions("Ice&Snow System", "Ice&Snow System", false, fns, this.sideGeoIconContainer);
	this.addPaletteFunctions("Solid Earth System", "Solid Earth System System", false, fns, this.sideGeoIconContainer);
	
	/*this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",0);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",0);
	
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",1);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",1);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",1);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",1);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",1);
	...
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",2);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",3);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",4);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",5);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",6);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",7);
	this.addCustomImage("https://www.npmjs.com/static/images/collaboration-security.svg",8);*/
};

var cur_sel_icon;
var cur_sel_icon_container;
var cur_sel_icon_class;

var global_img_idx = 0;

Sidebar.prototype.getIconClassificationContainer=function(idx){
	var temp = this.sideGeoIconContainer.firstElementChild;
	
	if (idx==0)
		temp = temp.nextSibling.firstElementChild;
	else if (idx==1)
		temp = temp.nextSibling.nextSibling.nextSibling.firstElementChild;
	else if (idx==2)
		temp = temp.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.firstElementChild;
	else if (idx==3)
	{
		temp = temp.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling;
		temp = temp.nextSibling.nextSibling.firstElementChild;
	}
	else if (idx==4)
	{
		temp = temp.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling;
		temp = temp.nextSibling.nextSibling.nextSibling.nextSibling.firstElementChild;
	}
	else if (idx==5)
	{
		temp = temp.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling;
		temp = temp.nextSibling.nextSibling.nextSibling.nextSibling;
		temp = temp.nextSibling.nextSibling.firstElementChild;
	}
	else if (idx==6)
	{
...
Sidebar.prototype.addCustomImage=function(url_str, idx){
	var fns = [];

	fns.push(this.createVertexTemplateEntry('image;html=1;imageAspect=0;labelBackgroundColor=#ffffff;image='+url_str,
				this.defaultImageWidth, this.defaultImageHeight, '', "geo_modeling"+global_img_idx, false, null, null));
	global_img_idx++;
	
	var temp = this.getIconClassificationContainer(idx);
		
	var cc = document.getElementById("geoicon");
	for (var i = 0; i < fns.length; i++)
	{
		var item = fns[i](this.sideGeoIconContainer);
		item.setAttribute("icon_uid",url_str)
		temp.appendChild(item);
		item.oncontextmenu = function(event){  
			var event = event || window.event; 
			var sider_context_menu = document.getElementById("icon_contex_menu");
			sider_context_menu.style.display="inline";
			sider_context_menu.style.left = event.x + "px";
			sider_context_menu.style.top = event.y + "px";
			
			var palette_context_menu = document.getElementById("palatte_contex_menu");
			palette_context_menu.style.display="none";
				
			cur_sel_icon = this;
			cur_sel_icon_container = temp;
			cur_sel_icon_class = idx;
			//alert("hell0");
			return false;
		};
		
		temp.oncontextmenu = function(event){  
			var event = event || window.event; 
			if (cur_sel_icon==null || cur_sel_icon==undefined)
			{
				var sider_context_menu = document.getElementById("palatte_contex_menu");
				sider_context_menu.style.display="inline";
				sider_context_menu.style.left = event.x + "px";
				sider_context_menu.style.top = event.y + "px";
...
Sidebar.prototype.addGeoIconQuick=function(url)
{
	this.addCustomImage(url, cur_sel_icon_class);
};

Sidebar.prototype.linkToIcon=function()
{
	window.open("");
};

Sidebar.prototype.removeCustomImage=function()
{
	if (cur_sel_icon_container!=null && cur_sel_icon!=null)
	{
		cur_sel_icon_container.removeChild(cur_sel_icon);
	}
};

Sidebar.prototype.removeAllIcon=function()
{
	cur_sel_icon_container.innerHTML = "";
};

Sidebar.prototype.clearIconList=function()
{
	for (var i=0; i<9; i++)
	{
		var temp = this.getIconClassificationContainer(i);
		temp.innerHTML = "";
	}
};

Sidebar.prototype.getAllLoadedIcon=function()
{
	var doc = mxUtils.createXmlDocument();
	var task_obj = doc.createElement('task');
	doc.appendChild(task_obj);
	for (var i=0; i<9; i++)
	{
		var temp_class_obj = doc.createElement('icon_class');
		temp_class_obj.setAttribute('type', i);
		task_obj.appendChild(temp_class_obj);
		
		var temp_container = this.getIconClassificationContainer(i);
		...
		for (var icon=0; icon<temp_count; icon++)
		{
			...
			var temp_icon_obj = doc.createElement('icon');
			temp_icon_obj.setAttribute("icon_uid", temp_uid);
			temp_class_obj.appendChild(temp_icon_obj);
		}
	}
...
Sidebar.prototype.loadIconFromTask=function(xml_str, preserve)
{
	if (xml_str == null)
	{
		xml_str = this.getAllLoadedIcon().outerHTML;
	}
	if (preserve!=true)
	{
		this.clearIconList();
	}
	var doc = mxUtils.parseXml(xml_str);
	var count = doc.documentElement.childElementCount;
	for (var i=0; i<count; i++)
	{
		var temp_class_item = doc.documentElement.childNodes[i];
		var class_id = temp_class_item.getAttribute("type");
		
		var temp_count = temp_class_item.childElementCount;
		for (var item=0; item<temp_count; item++)
		{
			var temp_icon_item = temp_class_item.childNodes[item];
			var temp_uid = temp_icon_item.getAttribute("icon_uid");
			
			this.addCustomImage(temp_uid, class_id);
		}
	}
};
	...
	var fns = [
		...
		this.createVertexTemplateEntry('text;html=1;strokeColor=#c0c0c0;fillColor=none;overflow=fill;', 180, 140,
	 	...
	 	this.addEntry('link hyperlink', mxUtils.bind(this, function()
	 	{
	 		...
	 		cell.vertex = true;
	 		this.graph.setLinkForCell(cell, 'https://GeoModelingNew.njnu.edu.cn');
	 	...
	 	{
	 		var cell = new mxCell('Variable', new mxGeometry(0, 0, 80, 20), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;overflow=hidden;');
	 		cell.vertex = true;
	 		this.graph.setAttributeForCell(cell, 'placeholders', '1');
...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	var fns =
	[
	 	this.createVertexTemplateEntry('shape=ext;rounded=1;html=1;whiteSpace=wrap;', 120, 80, 'Record', 'Process', null, null, 'bpmn task process'),
		...
		this.addEntry('bpmn receive task', function()
		{
			...
			return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'Receive Record');
		}),
		this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'user_task').join(' '), function()
		{
			...
			return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'User Record');
		}),
		...
		this.createVertexTemplateEntry('shape=datastore;whiteSpace=wrap;html=1;', 60, 60, '', 'Data Store', null, null, 'bpmn data store'),
	 	...
	 	this.createVertexTemplateEntry('shape=message;whiteSpace=wrap;html=1;fillColor=#000000;strokeColor=#ffffff;strokeWidth=2;', 40, 30, '', 'Send Record', null, null, 'bpmn send task'),
	 	this.createVertexTemplateEntry('shape=message;whiteSpace=wrap;html=1;', 40, 30, '', 'Receive Record', null, null, 'bpmn receive task'),
	 	this.createVertexTemplateEntry('shape=mxgraph.bpmn.user_task;html=1;', 14, 14, '', 'User Record', null, null, this.getTagsForStencil('mxgraph.bpmn', 'user_task').join(' ')),
	 	this.createVertexTemplateEntry('shape=mxgraph.bpmn.manual_task;html=1;', 14, 14, '', 'Manual Record', null, null, this.getTagsForStencil('mxgraph.bpmn', 'user_task').join(' ')),
	 	this.createVertexTemplateEntry('shape=mxgraph.bpmn.business_rule_task;html=1;', 14, 14, '', 'Business Rule Record', null, null, this.getTagsForStencil('mxgraph.bpmn', 'business_rule_task').join(' ')),
	 	this.createVertexTemplateEntry('shape=mxgraph.bpmn.service_task;html=1;', 14, 14, '', 'Service Record', null, null, this.getTagsForStencil('mxgraph.bpmn', 'service_task').join(' ')),
	 	this.createVertexTemplateEntry('shape=mxgraph.bpmn.script_task;html=1;', 14, 14, '', 'Script Record', null, null, this.getTagsForStencil('mxgraph.bpmn', 'script_task').join(' ')),
