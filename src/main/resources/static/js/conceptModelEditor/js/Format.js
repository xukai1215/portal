...
Format.prototype.refresh = function()
{
	...
	{
        this.editorUi.diagramContainer.style.right = "0px";
	...
	{
        this.editorUi.diagramContainer.style.right = "240px";
...
ArrangePanel.prototype.addAlign = function(div)
{
	...
	var left = this.editorUi.toolbar.addButton_Left('geSprite-alignleft', mxResources.get('left'),
		function() { graph.alignCells(mxConstants.ALIGN_LEFT); }, stylePanel);
	var center = this.editorUi.toolbar.addButton_Left('geSprite-aligncenter', mxResources.get('center'),
		function() { graph.alignCells(mxConstants.ALIGN_CENTER); }, stylePanel);
	var right = this.editorUi.toolbar.addButton_Left('geSprite-alignright', mxResources.get('right'),
		function() { graph.alignCells(mxConstants.ALIGN_RIGHT); }, stylePanel);

	var top = this.editorUi.toolbar.addButton_Left('geSprite-aligntop', mxResources.get('top'),
		function() { graph.alignCells(mxConstants.ALIGN_TOP); }, stylePanel);
	var middle = this.editorUi.toolbar.addButton_Left('geSprite-alignmiddle', mxResources.get('middle'),
		function() { graph.alignCells(mxConstants.ALIGN_MIDDLE); }, stylePanel);
	var bottom = this.editorUi.toolbar.addButton_Left('geSprite-alignbottom', mxResources.get('bottom'),
...
ArrangePanel.prototype.addStroke = function(container)
{
	...
	styleSelect.style.right = '12px';
	styleSelect.style.width = '10px';
	...
	stylePanel.style.position = 'relative';
	stylePanel.style.paddingLeft = '1px'
	...
	var pattern = this.editorUi.toolbar.addMenuFunctionInContainer_Left(stylePanel, 'geSprite-orthogonal', mxResources.get('pattern'), false, mxUtils.bind(this, function(menu)
	{
	...
	var edgeShape = this.editorUi.toolbar.addMenuFunctionInContainer_Left(altStylePanel, 'geSprite-connection', mxResources.get('connection'), false, mxUtils.bind(this, function(menu)
	{
	...
	var altPattern = this.editorUi.toolbar.addMenuFunctionInContainer_Left(altStylePanel, 'geSprite-orthogonal', mxResources.get('pattern'), false, mxUtils.bind(this, function(menu)
	{
	...
	var edgeStyle = this.editorUi.toolbar.addMenuFunctionInContainer_Left(stylePanel2, 'geSprite-orthogonal', mxResources.get('waypoints'), false, mxUtils.bind(this, function(menu)
	{
	...
	var lineStart = this.editorUi.toolbar.addMenuFunctionInContainer_Left(stylePanel2, 'geSprite-startclassic', mxResources.get('linestart'), false, mxUtils.bind(this, function(menu)
	{
	...
	var lineEnd = this.editorUi.toolbar.addMenuFunctionInContainer_Left(stylePanel2, 'geSprite-endclassic', mxResources.get('lineend'), false, mxUtils.bind(this, function(menu)
	{
		if (ss.style.shape == 'connector' || ss.style.shape == 'flexArrow')
		{
...
TextFormatPanel.prototype.addFont = function(container)
{
	...
	var fontStyleItems = this.editorUi.toolbar.addItems_Left(['bold', 'italic', 'underline'], stylePanel2, true);
	...
	var verticalItem = this.editorUi.toolbar.addItems_Left(['vertical'], stylePanel2, true)[0];
	...
	var left = this.editorUi.toolbar.addButton_Left('geSprite-left', mxResources.get('left'),
			(graph.cellEditor.isContentEditing()) ?
			function()
			{
				document.execCommand('justifyleft', false, null);
			} : this.editorUi.menus.createStyleChangeFunction([mxConstants.STYLE_ALIGN], [mxConstants.ALIGN_LEFT]), stylePanel3);
	var center = this.editorUi.toolbar.addButton_Left('geSprite-center', mxResources.get('center'),
			(graph.cellEditor.isContentEditing()) ?
			function()
			{
				document.execCommand('justifycenter', false, null);
			} : this.editorUi.menus.createStyleChangeFunction([mxConstants.STYLE_ALIGN], [mxConstants.ALIGN_CENTER]), stylePanel3);
	var right = this.editorUi.toolbar.addButton_Left('geSprite-right', mxResources.get('right'),
			(graph.cellEditor.isContentEditing()) ?
			function()
			{
	...
	if (graph.cellEditor.isContentEditing())
	{
		var clear = this.editorUi.toolbar.addButton_Left('geSprite-removeformat', mxResources.get('removeFormat'),
			function()
			{
	...
	var top = this.editorUi.toolbar.addButton_Left('geSprite-top', mxResources.get('top'),
		this.editorUi.menus.createStyleChangeFunction([mxConstants.STYLE_VERTICAL_ALIGN], [mxConstants.ALIGN_TOP]), stylePanel3);
	var middle = this.editorUi.toolbar.addButton_Left('geSprite-middle', mxResources.get('middle'),
		this.editorUi.menus.createStyleChangeFunction([mxConstants.STYLE_VERTICAL_ALIGN], [mxConstants.ALIGN_MIDDLE]), stylePanel3);
	var bottom = this.editorUi.toolbar.addButton_Left('geSprite-bottom', mxResources.get('bottom'),
	...
	if (graph.cellEditor.isContentEditing())
	{
		...
		full = this.editorUi.toolbar.addButton_Left('geSprite-justifyfull', null,
			function()
			{
				document.execCommand('justifyfull', false, null);
			}, stylePanel3);
		this.styleButtons([full,
       		sub = this.editorUi.toolbar.addButton_Left('geSprite-subscript', mxResources.get('subscript') + ' (Ctrl+,)',
			function()
			{
				document.execCommand('subscript', false, null);
			}, stylePanel3), sup = this.editorUi.toolbar.addButton_Left('geSprite-superscript', mxResources.get('superscript') + ' (Ctrl+.)',
			function()
			{
		...
		var btns = [this.editorUi.toolbar.addButton_Left('geSprite-orderedlist', mxResources.get('numberedList'),
				function()
				{
					document.execCommand('insertorderedlist', false, null);
				}, tmp),
			this.editorUi.toolbar.addButton_Left('geSprite-unorderedlist', mxResources.get('bulletedList'),
				function()
				{
					document.execCommand('insertunorderedlist', false, null);
				}, tmp),
			this.editorUi.toolbar.addButton_Left('geSprite-outdent', mxResources.get('decreaseIndent'),
					function()
					{
						document.execCommand('outdent', false, null);
					}, tmp),
			this.editorUi.toolbar.addButton_Left('geSprite-indent', mxResources.get('increaseIndent'),
				function()
				{
					document.execCommand('indent', false, null);
				}, tmp),
			this.editorUi.toolbar.addButton_Left('geSprite-code', mxResources.get('html'),
				function()
				{
	...
	else
	{
		...
		var insertBtns = this.editorUi.toolbar.addItems_Left(['link', 'image'], insertPanel, true);

		var btns = [
		        this.editorUi.toolbar.addButton_Left('geSprite-horizontalrule', mxResources.get('insertHorizontalRule'),
				function()
				{
					document.execCommand('inserthorizontalrule', false, null);
				}, insertPanel),				
				this.editorUi.toolbar.addMenuFunctionInContainer_Left(insertPanel, 'geSprite-table', mxResources.get('table'), false, mxUtils.bind(this, function(menu)
				{
		...
		var btns = [
		        this.editorUi.toolbar.addButton_Left('geSprite-insertcolumnbefore', mxResources.get('insertColumnBefore'),
				function()
				{
					try
					{
				...
				this.editorUi.toolbar.addButton_Left('geSprite-insertcolumnafter', mxResources.get('insertColumnAfter'),
				function()
				{
					try
					{
				...
				this.editorUi.toolbar.addButton_Left('geSprite-deletecolumn', mxResources.get('deleteColumn'),
				function()
				{
					try
					{
				...
				this.editorUi.toolbar.addButton_Left('geSprite-insertrowbefore', mxResources.get('insertRowBefore'),
				function()
				{
					try
					{
				...
				this.editorUi.toolbar.addButton_Left('geSprite-insertrowafter', mxResources.get('insertRowAfter'),
				function()
				{
					try
					{
				...
				this.editorUi.toolbar.addButton_Left('geSprite-deleterow', mxResources.get('deleteRow'),
				function()
				{
					try
					{
		...
		var btns = [
		        this.editorUi.toolbar.addButton_Left('geSprite-strokecolor', mxResources.get('borderColor'),
				...
				this.editorUi.toolbar.addButton_Left('geSprite-fillcolor', mxResources.get('backgroundColor'),
				mxUtils.bind(this, function()
				{
					// Converts rgb(r,g,b) values
					if (currentTable != null)
				...
				this.editorUi.toolbar.addButton_Left('geSprite-fit', mxResources.get('spacing'),
				function()
				{
					if (currentTable != null)
					{
				...
				this.editorUi.toolbar.addButton_Left('geSprite-left', mxResources.get('left'),
				function()
				{
					if (currentTable != null)
					{
				...
				this.editorUi.toolbar.addButton_Left('geSprite-center', mxResources.get('center'),
				function()
				{
					if (currentTable != null)
					{
				...
				this.editorUi.toolbar.addButton_Left('geSprite-right', mxResources.get('right'),
				function()
				{
					if (currentTable != null)
					{
...
StyleFormatPanel.prototype.addModelDescription = function(div)
{
	var ui = this.editorUi;
	var editor = ui.editor;
	var graph = editor.graph;
...
StyleFormatPanel.prototype.addModelItem = function(div)
{
	var ui = this.editorUi;
	var editor = ui.editor;
	var graph = editor.graph;
	
	var btn = mxUtils.button("Edit Related Models", mxUtils.bind(this, function(evt)
	{
		this.editorUi.actions.get('editModel').funct(function(){
			var cell = graph.getSelectionCell();
			var value = graph.getModel().getValue(cell);
			var model_items = value.getAttribute("relate_models");
			div.childNodes[2].innerHTML = "";

			if (model_items != null && model_items != "")
			{
                var ul = document.createElement("ul");
                ul.style.paddingLeft =	"0px";
                var modelItems = JSON.parse(model_items);
                for(var i=0;i<modelItems.length;i++){
                    var li = document.createElement("li");
                    li.id = modelItems[i].uid;
                    var a = document.createElement("a");
                    a.innerHTML  = modelItems[i].name;;
                    a.setAttribute("href","http://localhost:8081/GeoModelingNew/En/model/modelItemInfo.html?uid="+encode64(encode64(modelItems[i].uid)));
                    a.target = "_blank";
                    li.appendChild(a);
                    ul.appendChild(li);
                }
				div.childNodes[2].appendChild(ul);
			}
		});
	}));
	
	btn.setAttribute('title', "Edit Related Models");
	...
	model_col.style.height = "100px";
	model_col.style.width = "200px";
	model_col.style.maxWidth = "200px";
	model_col.style.borderWidth = "1px";
	model_col.style.borderStyle = "solid";
	model_col.style.overflowY = "auto";
    model_col.id = "model_col";
	
	div.appendChild(model_col);
	...
	if (value != null && typeof(value)!="string")
	{
		...
		if (model_items != null && model_items != "")
		{
			...
			model_col.appendChild(ul);
		}
	}
	return div;
};

StyleFormatPanel.prototype.addConceptItem = function(div)
{
	var ui = this.editorUi;
	var editor = ui.editor;
	var graph = editor.graph;
	
	var btn = mxUtils.button("Edit Related Concepts", mxUtils.bind(this, function(evt)
	{
		this.editorUi.actions.get('editConcept').funct(function(){
			var cell = graph.getSelectionCell();
			var value = graph.getModel().getValue(cell);
			var concept_items = value.getAttribute("relate_concepts");
			div.childNodes[2].innerHTML = "";
			if (concept_items != null && concept_items != "")
			{
				var ul = document.createElement("ul");
                ul.style.paddingLeft =	"0px";
				var concepts = JSON.parse(concept_items);
				for(var i=0;i<concepts.length;i++){
					var li = document.createElement("li");
                    li.id = concepts[i].uid;
                    var a = document.createElement("a");
                    a.innerHTML  = concepts[i].name;;
                    a.setAttribute("href","http://localhost:8081/GeoModelingNew/En/data/conceptInfo.html?uid="+encode64(encode64(concepts[i].uid)));
                    a.target = "_blank";
                    li.appendChild(a);
					ul.appendChild(li);
				}
	...
	btn.setAttribute('title', "Edit Related Concepts");
	btn.style.width = '180px';
	btn.style.marginBottom = '2px';
	div.appendChild(btn);
	...
	var concept_col = document.createElement("div");
	concept_col.style.height = "100px";
	concept_col.style.width = "200px";
	concept_col.style.maxWidth = "200px";
	concept_col.style.borderWidth = "1px";
	concept_col.style.borderStyle = "solid";
    concept_col.id = "concept_col";
	
	div.appendChild(concept_col);
...
DiagramFormatPanel.prototype.addSceneDescription = function(div)
{
	var ui = this.editorUi;
	var editor = ui.editor;
	var graph = editor.graph;
    ...
    textbox.onblur = function () {
        ...
        var obj = doc.createElement('object');
        value = obj;
        var content = document.getElementById('model_scene_description').value;
        value.setAttribute("model_scene", content);
    ...
    text.onblur = function () {
        ...
        obj.setAttribute('label', value || '');
        value = obj;
        value.setAttribute("model_scene", text.value);
        var nameContent = document.getElementById('model_scene_name').value;
        value.setAttribute("model_name", nameContent);
        graph.getModel().setValue(cell, value);
    };
	...
	if (value != null)
	{
		var description = value.getAttribute("model_scene");
		var name = value.getAttribute("model_name");
		text.value = description;
		textbox.value = name;
	}
	return div;
...
DiagramFormatPanel.prototype.addView = function(div)
{
	...
	if (graph.isEnabled())
	{
		...
		// Page View
		var page_view_ele = this.createOption(mxResources.get('pageView'), function()
		{
		...
		page_view_ele.checked = false;
		div.appendChild(page_view_ele);
