 ...
 */
EditorUi.prototype.footerHeight = 0;//xk
 ...
 * screen widths <= 500px.
 */
EditorUi.prototype.hsplitPosition = (screen.width <= 640) ? ((screen.width <= 360) ? 62 : 116) : 298;
...
EditorUi.prototype.refresh = function(sizeDidChange)
{
	...
	{
		this.menubarHeight = 50;//与顶部间距  许凯
		tmp += this.menubarHeight;
	}
...
EditorUi.prototype.createDivs = function()
{
	...
	this.formatContainer.style.fontSize = '13px';
...
EditorUi.prototype.addIconContextMenu = function()
{
	var sider_context_menu = document.createElement("div");
	document.body.appendChild(sider_context_menu);
	sider_context_menu.style.display = "none";
	sider_context_menu.style.zIndex = "10008";
	sider_context_menu.className = "mxPopupMenu";
	sider_context_menu.id = "icon_contex_menu";
	
	var mSidebar = this.sidebar;
	
	var menu_table = document.createElement("table");
	menu_table.className = "mxPopupMenu";
	var menu_table_body = document.createElement("tbody");
	menu_table.appendChild(menu_table_body);
	
	var menu_table_tr1 = document.createElement("tr");
	menu_table_tr1.className = "mxPopupMenuItem";
	menu_table_body.appendChild(menu_table_tr1);		
	var remove_menu = document.createElement("td");
	remove_menu.className = 'mxPopupMenuItem';
	remove_menu.innerText = "Remove this icon";
	menu_table_tr1.onmouseover=function(){
		menu_table_tr1.className = "mxPopupMenuItemHover";
		menu_table_tr2.className = "mxPopupMenuItem";
	};
	menu_table_tr1.onclick=function(){
		if (mSidebar!=null)
		{
			mSidebar.removeCustomImage();
		}
	};
	menu_table_tr1.appendChild(remove_menu);
	
	var menu_table_tr2 = document.createElement("tr");
	menu_table_tr2.className = "mxPopupMenuItem";
	menu_table_body.appendChild(menu_table_tr2);
	var attribute_menu = document.createElement("td");
	attribute_menu.className = 'mxPopupMenuItem';
	attribute_menu.innerText = "Find this icon";
	menu_table_tr2.onmouseover=function(){
		menu_table_tr2.className = "mxPopupMenuItemHover";
		menu_table_tr1.className = "mxPopupMenuItem";
	};
	menu_table_tr2.onclick=function(){
		if (mSidebar!=null)
		{
			mSidebar.linkToIcon();
		}
	};
	menu_table_tr2.appendChild(attribute_menu);
	
	sider_context_menu.appendChild(menu_table);
	
	document.addEventListener("click",function(){
		sider_context_menu.style.display = "none";
		cur_sel_icon = null;
		cur_sel_icon_container = null;
	},false);
};

EditorUi.prototype.addPaletteContextMenu = function()
{
	var sider_context_menu = document.createElement("div");
	document.body.appendChild(sider_context_menu);
	sider_context_menu.style.display = "none";
	sider_context_menu.style.zIndex = "10008";
	sider_context_menu.className = "mxPopupMenu";
	sider_context_menu.id = "palatte_contex_menu";
	...
	var remove_menu = document.createElement("td");
	remove_menu.className = 'mxPopupMenuItem';
	remove_menu.innerText = "Add other icon";
	menu_table_tr1.onmouseover=function(){
		menu_table_tr1.className = "mxPopupMenuItemHover";
		menu_table_tr2.className = "mxPopupMenuItem";
	};
	menu_table_tr1.onclick=function(){
		if (mSidebar!=null)
		{
			alert("Add other icon");
			mSidebar.addGeoIconQuick("https://img.alicdn.com/imgextra/i1/2814722036/TB2CrBFqYlmpuFjSZFlXXbdQXXa_!!2814722036.jpg_60x60q90.jpg");
		}
	};
	menu_table_tr1.appendChild(remove_menu);
	...
	var attribute_menu = document.createElement("td");
	attribute_menu.className = 'mxPopupMenuItem';
	attribute_menu.innerText = "Remove all icon";
	menu_table_tr2.onmouseover=function(){
		menu_table_tr2.className = "mxPopupMenuItemHover";
		menu_table_tr1.className = "mxPopupMenuItem";
	};
...
EditorUi.prototype.createUi = function()
{
	...
	if (this.format != null)
	{
		...
		this.formatContainer.oncontextmenu = function(event){  
			var event = event || window.event;  
			return false;
		};
	}
	...
	if (footer != null)
	{
		...
		this.footerContainer.oncontextmenu = function(event){  
			var event = event || window.event;  
			return false;
		};
	}
	...
	if (this.toolbar != null)
	{
		...
		this.toolbarContainer.oncontextmenu = function(event){  
			var event = event || window.event;  
			return false;
		};
	}
