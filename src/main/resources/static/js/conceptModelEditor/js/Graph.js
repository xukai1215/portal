...
Graph.prototype.init = function(container)
{
    ...
    //
    // this.addStencilPalette('flowchart','Flowchart', dir + '/logical.xml', ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		{
			if (this.isEnabled() && editMode==true)
			{
