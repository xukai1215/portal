 ...
 * 
 * Specifies if edges should automatically be moved into the nearest other
 ...
 * other ancestors of an edge's terminals. Default is true.
 */
...
mxGraphModel.prototype.add = function(parent, child, index)
{
	...
	{	
		...
		// into the nearest other ancestor of its
		// terminals
...
mxGraphModel.prototype.updateEdgeParents = function(cell, root)
{
	...
	for (var i = 0; i < edges.length; i++)
	{
		...
		// a other root node (does not need to be the
		// model root node)
 ...
 * nearest-other-ancestor of its two terminals.
 *
 * Parameters:
 * 
 ...
 * 
 * Returns the nearest other ancestor for the specified cells.
 *
 * Parameters:
 * 
...
mxGraphModel.prototype.getNearestCommonAncestor = function(cell1, cell2)
{
	...
	{		
		...
		if (path != null && path.length > 0)
		{
			...
			// cell to find the nearest other ancestor.
			var cell = cell1;
