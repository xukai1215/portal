 ...
 * 
 * (code)
 * <Record label="Record" description="">
 *   <mxCell vertex="true">
 ...
 * the cell. This means the user object of the cell is the Record node with no
 ...
 * (end)
 * 
 * The Record node can have any tag name, attributes and child nodes. The
 ...
 * time. For example, if the Record node from above has an id attribute, then
