...
Toolbar.prototype.init = function()
{
	...
	if (editMode==undefined || editMode==true)
	{
		this.addItem_Left("geSprite-plus", 'Add_GeoIcon');
		this.addItem_Left("geSprite-opentask", 'Open_Task');
		this.addItem_Left("geSprite-savetask", 'Save_Task');
		this.addItem_Left("geSprite-loadscene", 'Load_Model_Scene');
		this.addItem_Left("geSprite-publishscene", 'Publish_Model_Scene');
		//this.addItem_Left("geSprite-exportimage", 'Export_Image');
	}
	else
	{
		this.addItem_Left("geSprite-loadscene", 'Load_Model_Scene');
 ...
 * Adds a label to the toolbar.
 */
Toolbar.prototype.addMenuFunctionInContainer_Left = function(container, label, tooltip, showLabels, funct, showAll)
{
 ...
 */
Toolbar.prototype.addSeparator_Left = function(c)
{
 ...
 */
Toolbar.prototype.addItems_Left = function(keys, c, ignoreDisabled)
{
	var items = [];
	...
	for (var i = 0; i < keys.length; i++)
	{
		...
		if (key == '-')
		{
			items.push(this.addSeparator_Left(c));
		}
		else
		{
			items.push(this.addItem_Left('geSprite-' + key.toLowerCase(), key, c, ignoreDisabled));
		}
	}
 ...
 * Adds given action item
 */
Toolbar.prototype.addItem_Left = function(sprite, key, c, ignoreDisabled)
{
	var action = this.editorUi.actions.get(key);
	var elt = null;
	...
	if (elt!=null) elt.style.float = "left";
	return elt;
};
 ...
 */
Toolbar.prototype.addButton_Left = function(classname, tooltip, funct, c)
{
