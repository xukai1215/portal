...
var AddIconDialog = function(editorUi)
{
    ...
    p.innerHTML = "you can create your own icon <a href='http://localhost:8081/GeoModelingNew/En/building/geoIconEditor.html'>click</a>";
    pdiv.appendChild(p);
    ...
    {
    	$.ajax({
            url:"http://222.192.7.75/GeoModelingNew/getIconRelationServlet",
            type:"get",
			success:function (result) {
                ...
                $.ajax({
                    url:"http://222.192.7.75/GeoModelingNew/geoIconListServlet",
                    type:"get",
...
var OpenTaskDialog = function (editorUi) {
    ...
    curli.className = "cur";
    curli.innerHTML = "Online Record";
    var li  = document.createElement("li");
    li.innerHTML = "Upload Record";
    ...
    this.init = function()
    {
        ...
        $("#taskFileXml").change(function () {
            ...
            if(type.indexOf("xml")>=0){
               ...
               $.ajax({
                   url: "http://localhost:8081/GeoModelingNew/LoadTaskXmlServlet",
                   type: "POST",
                   data: formData,
                   async: false,
    ...
    this.init = function()
    {
        ...
        $("#conceptualFileXml").change(function () {
            ...
            if(type.indexOf("xml")>=0){
                ...
                $.ajax({
                    url: "http://localhost:8081/GeoModelingNew/LoadConceptualModelXmlServlet",
                    type: "POST",
                    data: formData,
                    async: false,
                    success: function (msg) {
