 ...
 * 
 * Defines the default language which is used in the other resource files. Any
 * resources for this language will only load the other resource file, but not
...
{
	mxClient.link('stylesheet', mxClient.basePath + '/css/other.css');
}
