...
var AddIconDialog = function(editorUi)
{
    ...
    p.innerHTML = "you can create your own icon <a href='/GeoModeling/En/building/geoIconEditor.html'>click</a>";
    pdiv.appendChild(p);
    ...
    {
    	$.ajax({
            url:"http://222.192.7.75/GeoModeling/getIconRelationServlet",
            type:"get",
			success:function (result) {
                ...
                $.ajax({
                    url:"http://222.192.7.75/GeoModeling/geoIconListServlet",
                    type:"get",
        ...
        $(document).on('change','#iconParentSelect',function(){
            ...
            $.ajax({
                url:"/GeoModeling/geoIconListServlet",
                type:"get",
                data:{"uid":tempNameId,"page":"1","sortType":"name"},
                success:function (data) {
                    var result = JSON.parse(data);
...
var OpenTaskDialog = function (editorUi) {
    ...
    this.init = function()
    {
        ...
        firstPage = true;
        $.ajax({
			url:"/GeoModeling/IconTaskServlet",
			type:"get",
			data:{"page":1},
			success:function (result) {
				var info = JSON.parse(result);
        ...
        $("#taskFileXml").change(function () {
            ...
            if(type.indexOf("xml")>=0){
               ...
               $.ajax({
                   url: "/GeoModeling/LoadTaskXmlServlet",
                   type: "POST",
                   data: formData,
                   async: false,
    ...
    this.init = function()
    {
        ...
        $("#conceptualFileXml").change(function () {
            ...
            if(type.indexOf("xml")>=0){
                ...
                $.ajax({
                    url: "/GeoModeling/LoadConceptualModelXmlServlet",
                    type: "POST",
                    data: formData,
                    async: false,
                    success: function (msg) {
...
var EditRelatedModel = function(editorUi, cell, callback)
{
    ...
    this.init = function(){
		$.ajax({
            url:"/GeoModeling/ModelRepositoryServlet",
            type:"get",
            success:function(data){
                var result = data;
                ...
                $('#modelItemTree').on('nodeSelected', function (event, data) {
                    ...
                    if (data.nodes === undefined) {
                        firstPage = true;
                        $.ajax({
                            url:"/GeoModeling/ModelItemsServlet",
                            type:"get",
                            async:false,
		...
		searchBtn.onclick = function () {
            ...
            if(searchName===""){
                ...
                searchFlag = true;
                $.ajax({
                    url:"/GeoModeling/SearchModelItemsServlet",
                    type:"get",
                    async:false,
