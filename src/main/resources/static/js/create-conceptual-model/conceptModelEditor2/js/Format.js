		...
		this.editorUi.actions.get('editModel').funct(function(){
			...
			if (model_items != null && model_items != "")
			{
                ...
                for(var i=0;i<modelItems.length;i++){
                    ...
                    a.setAttribute("href","/GeoModeling/En/model/modelItemInfo.html?uid="+encode64(encode64(modelItems[i].uid)));
                    a.target = "_blank";
                    li.appendChild(a);
                    ul.appendChild(li);
                }
		...
		this.editorUi.actions.get('editConcept').funct(function(){
			...
			if (concept_items != null && concept_items != "")
			{
				...
				for(var i=0;i<concepts.length;i++){
                    ...
                    a.setAttribute("href","/GeoModeling/En/data/conceptInfo.html?uid="+encode64(encode64(concepts[i].uid)));
                    a.target = "_blank";
                    li.appendChild(a);
					ul.appendChild(li);
				}
